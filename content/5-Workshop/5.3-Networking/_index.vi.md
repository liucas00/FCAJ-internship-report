...
Để đảm bảo an toàn cho ứng dụng và cơ sở dữ liệu, mình chuẩn bị một môi trường mạng nội bộ (VPC) được thiết kế khép kín và phân tầng rõ ràng. 

Chiến lược ở đây là tách biệt luồng truy cập thành hai vùng:

*   **Public Subnet**: Khu vực tiếp xúc trực tiếp với Internet. Mình sẽ đặt Load Balancer tại đây để nhận traffic từ ngoài vào.
...
Mình tiến hành khởi tạo mạng riêng ảo với các thông số được tối ưu cho Cloud Finance Platform. Các bước thực hiện như sau:
...
Tiếp theo, mình định nghĩa 4 nhóm Security Groups. Bằng việc áp dụng quy tắc đặc quyền tối thiểu (least privilege), mình đảm bảo các tài nguyên chỉ có thể giao tiếp với đúng các thành phần được phép.
